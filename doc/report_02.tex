...
\usepackage[right=3.0cm,left=3.0cm,top=3.0cm, bottom=3.0cm,total={165mm,243mm}]{geometry}
...
\begin{figure}
\begin{center}
\includegraphics[ width=0.99\linewidth]{figures/resolution.pdf} 
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[ width=0.99\linewidth]{figures/variance.pdf} 
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[ width=0.99\linewidth]{figures/reward.pdf} 
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[ width=0.99\linewidth]{figures/discount.pdf} 
\end{center}
